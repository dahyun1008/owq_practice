...
void matquant3dequantoutlier(
  ...
  const at::cuda::OptionalCUDAGuard device_guard(device_of(scales));
  matquant3dequantoutlier_cuda(mat, out, scales, zeros, outlierMat, outlieridx, outrow, cnt);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("matquant3dequantoutlier", &matquant3dequantoutlier, "Dequantize 3-bit weight matrix to fp16, bf16 weight matrix, float16, bfloat16 faster version");
